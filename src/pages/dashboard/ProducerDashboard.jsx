    ...
    <div style={{
      ...
      <Container>
        ...
        <div style={{
          ...
          {producerStatus.isVerifiedProducer && (
            <div>
        ...
        {producerStatus.isVerifiedProducer ? (
          ...
          /* Estado no verificado: Banner informativo */
          <div style={{
            background: producerStatus.isPendingApproval 
              ? "rgba(255, 170, 0, 0.05)" 
              : "rgba(255, 68, 68, 0.05)",
            border: `1px solid ${producerStatus.isPendingApproval ? "#FFAA00" : "#FF4444"}`,
            borderRadius: "8px",
            padding: "32px",
            ...
            <div style={{
              fontSize: "18px",
              fontWeight: 900,
              color: producerStatus.isPendingApproval ? "#FFAA00" : "#FF4444",
              marginBottom: "12px",
              letterSpacing: "0.05em",
              textTransform: "uppercase",
              display: "flex",
              ...
              <span>{producerStatus.isPendingApproval ? "⚡ Registro Pendiente de Aprobación" : "❌ Registro Rechazado"}</span>
            </div>
            <p style={{
              margin: 0,
              fontSize: "14px",
              ...
              {producerStatus.isPendingApproval 
                ? "Tu cuenta de productor se ha creado correctamente, pero está pendiente de verificación por el equipo administrativo de VOY. Para mantener la seguridad y calidad de la plataforma, un administrador revisará tus datos a la brevedad. Una vez aprobado, podrás publicar eventos y gestionar tus entradas desde este panel."
                : "Lo sentimos, tu solicitud de productor ha sido rechazada por el administrador. Esto puede deberse a información incompleta o a que tu perfil no cumple con las directrices de la comunidad. Si crees que se trata de un error, por favor contacta a soporte escribiendo a soporte@voyproject.com."
              }
            </p>
          </div>
        )}

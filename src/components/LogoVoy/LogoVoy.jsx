...
export default function LogoVoy({ className = "", inverse = false }) {
  return (
    <Link to="/" className={`${styles.logoContainer} ${inverse ? styles.inverse : ""} ${className}`} aria-label="VOY Project Home">
